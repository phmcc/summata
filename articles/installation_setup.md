...
The following packages are required. Those distributed through CRAN are
installed automatically with `summata`; others are included in base R.

| Package | Purpose | Source |
|:---|:---|:---|
| `data.table` | High-performance data manipulation and core data operations | CRAN |
| `ggplot2` | Visualization system for forest plots and graphics | CRAN |
| `survival` | Survival and time-to-event analysis | Base R |
| `stats` | Statistical functions and model fitting | Base R |
| `grDevices` | Graphics devices and color palettes | Base R |
...
# Clean up
file.remove(
  "verification_test.docx",
  "verification_test.pdf"
)
```
