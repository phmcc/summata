...
#> Table exported to /tmp/Rtmp2vLXIU/results.docx
...
#> Table exported to /tmp/Rtmp2vLXIU/direct.docx
ft <- flextable::bg(ft, bg = "yellow", part = "header")
