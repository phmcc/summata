...
#> Table exported to /tmp/RtmpihKwyb/results.docx
...
#> Table exported to /tmp/RtmpihKwyb/direct.docx
ft <- flextable::bg(ft, bg = "yellow", part = "header")
