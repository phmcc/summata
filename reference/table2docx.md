...
#> Table exported to /tmp/RtmpTulUTc/results.docx
...
#> Table exported to /tmp/RtmpTulUTc/direct.docx
ft <- flextable::bg(ft, bg = "yellow", part = "header")
