...
#> Table exported to /tmp/RtmpTulUTc/results.html
...
#> Table exported to /tmp/RtmpTulUTc/email.html
...
table2html(results, file.path(tempdir(), "publication.html"),
          ...
          bold_significant = TRUE,
          dark_header = FALSE)
#> Table exported to /tmp/RtmpTulUTc/publication.html
...
table2html(results, file.path(tempdir(), "dark_theme.html"),
          ...
          zebra_stripes = TRUE)
#> Table exported to /tmp/RtmpTulUTc/dark_theme.html
...
table2html(results, file.path(tempdir(), "minimal.html"),
          ...
          format_headers = FALSE,
          bold_significant = FALSE)
#> Table exported to /tmp/RtmpTulUTc/minimal.html
...
#> Table exported to /tmp/RtmpTulUTc/comparison.html
