...
#> Table saved to /tmp/Rtmp3J9jIQ/results.html
...
#> Table saved to /tmp/Rtmp3J9jIQ/email.html
...
table2html(results, file.path(tempdir(), "publication.html"),
          ...
          bold_significant = TRUE,
          dark_header = FALSE)
#> Table saved to /tmp/Rtmp3J9jIQ/publication.html
...
table2html(results, file.path(tempdir(), "dark_theme.html"),
          ...
          zebra_stripes = TRUE)
#> Table saved to /tmp/Rtmp3J9jIQ/dark_theme.html
...
table2html(results, file.path(tempdir(), "minimal.html"),
          ...
          format_headers = FALSE,
          bold_significant = FALSE)
#> Table saved to /tmp/Rtmp3J9jIQ/minimal.html
...
#> Table saved to /tmp/Rtmp3J9jIQ/comparison.html
