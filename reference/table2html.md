...
#> Table exported to /tmp/Rtmppp0ueS/email.html
...
table2html(results, file.path(tempdir(), "publication.html"),
          ...
          bold_significant = TRUE,
          dark_header = FALSE)
#> Table exported to /tmp/Rtmppp0ueS/publication.html
...
table2html(results, file.path(tempdir(), "dark_theme.html"),
          ...
          zebra_stripes = TRUE)
#> Table exported to /tmp/Rtmppp0ueS/dark_theme.html
...
table2html(results, file.path(tempdir(), "minimal.html"),
          ...
          format_headers = FALSE,
          bold_significant = FALSE)
#> Table exported to /tmp/Rtmppp0ueS/minimal.html
...
#> Table exported to /tmp/Rtmppp0ueS/comparison.html
