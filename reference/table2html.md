...
#> Table saved to /tmp/RtmpPQeTCd/email.html
...
table2html(results, file.path(tempdir(), "publication.html"),
          ...
          bold_significant = TRUE,
          dark_header = FALSE)
#> Table saved to /tmp/RtmpPQeTCd/publication.html
...
table2html(results, file.path(tempdir(), "dark_theme.html"),
          ...
          zebra_stripes = TRUE)
#> Table saved to /tmp/RtmpPQeTCd/dark_theme.html
...
table2html(results, file.path(tempdir(), "minimal.html"),
          ...
          format_headers = FALSE,
          bold_significant = FALSE)
#> Table saved to /tmp/RtmpPQeTCd/minimal.html
...
#> Table saved to /tmp/RtmpPQeTCd/comparison.html
