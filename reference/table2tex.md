...
#> Table saved to /tmp/RtmpPQeTCd/basic.tex
...
table2tex(results, file.path(tempdir(), "publication.tex"),
       ...
       label = "tab:regression")
#> Table saved to /tmp/RtmpPQeTCd/publication.tex
...
table2tex(results, file.path(tempdir(), "striped.tex"),
       ...
       booktabs = TRUE)
#> Table saved to /tmp/RtmpPQeTCd/striped.tex
...
table2tex(results, file.path(tempdir(), "dark_header.tex"),
       dark_header = TRUE,
       booktabs = TRUE)
#> Table saved to /tmp/RtmpPQeTCd/dark_header.tex
...
table2tex(results, file.path(tempdir(), "strict_sig.tex"),
       ...
       booktabs = TRUE)
#> Table saved to /tmp/RtmpPQeTCd/strict_sig.tex
...
#> Table saved to /tmp/RtmpPQeTCd/caption_size.tex
...
table2tex(results, file.path(tempdir(), "final_table1.tex"),
       ...
       bold_significant = TRUE,
       cell_padding = "normal")
#> Table saved to /tmp/RtmpPQeTCd/final_table1.tex
...
table2tex(desc_table, file.path(tempdir(), "table1_descriptive.tex"),
       ...
       label = "tab:baseline")
#> Table saved to /tmp/RtmpPQeTCd/table1_descriptive.tex
...
table2tex(comparison, file.path(tempdir(), "model_comparison.tex"),
       ...
       label = "tab:models")
#> Table saved to /tmp/RtmpPQeTCd/model_comparison.tex
