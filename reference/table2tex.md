...
#> Table exported to /tmp/Rtmp2vLXIU/basic.tex
...
table2tex(results, file.path(tempdir(), "publication.tex"),
       ...
       label = "tab:regression")
#> Table exported to /tmp/Rtmp2vLXIU/publication.tex
...
table2tex(results, file.path(tempdir(), "striped.tex"),
       ...
       booktabs = TRUE)
#> Table exported to /tmp/Rtmp2vLXIU/striped.tex
...
table2tex(results, file.path(tempdir(), "dark_header.tex"),
       dark_header = TRUE,
       booktabs = TRUE)
#> Table exported to /tmp/Rtmp2vLXIU/dark_header.tex
...
table2tex(results, file.path(tempdir(), "strict_sig.tex"),
       ...
       booktabs = TRUE)
#> Table exported to /tmp/Rtmp2vLXIU/strict_sig.tex
...
#> Table exported to /tmp/Rtmp2vLXIU/caption_size.tex
...
table2tex(results, file.path(tempdir(), "final_table1.tex"),
       ...
       bold_significant = TRUE,
       cell_padding = "normal")
#> Table exported to /tmp/Rtmp2vLXIU/final_table1.tex
...
table2tex(desc_table, file.path(tempdir(), "table1_descriptive.tex"),
       ...
       label = "tab:baseline")
#> Table exported to /tmp/Rtmp2vLXIU/table1_descriptive.tex
...
table2tex(comparison, file.path(tempdir(), "model_comparison.tex"),
       ...
       label = "tab:models")
#> Table exported to /tmp/Rtmp2vLXIU/model_comparison.tex
