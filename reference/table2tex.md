...
#> Table saved to /tmp/Rtmp3J9jIQ/basic.tex
...
table2tex(results, file.path(tempdir(), "publication.tex"),
       ...
       label = "tab:regression")
#> Table saved to /tmp/Rtmp3J9jIQ/publication.tex
...
table2tex(results, file.path(tempdir(), "striped.tex"),
       ...
       booktabs = TRUE)
#> Table saved to /tmp/Rtmp3J9jIQ/striped.tex
...
table2tex(results, file.path(tempdir(), "dark_header.tex"),
       dark_header = TRUE,
       booktabs = TRUE)
#> Table saved to /tmp/Rtmp3J9jIQ/dark_header.tex
...
table2tex(results, file.path(tempdir(), "strict_sig.tex"),
       ...
       booktabs = TRUE)
#> Table saved to /tmp/Rtmp3J9jIQ/strict_sig.tex
...
#> Table saved to /tmp/Rtmp3J9jIQ/caption_size.tex
...
table2tex(results, file.path(tempdir(), "final_table1.tex"),
       ...
       bold_significant = TRUE,
       cell_padding = "normal")
#> Table saved to /tmp/Rtmp3J9jIQ/final_table1.tex
...
table2tex(desc_table, file.path(tempdir(), "table1_descriptive.tex"),
       ...
       label = "tab:baseline")
#> Table saved to /tmp/Rtmp3J9jIQ/table1_descriptive.tex
...
table2tex(comparison, file.path(tempdir(), "model_comparison.tex"),
       ...
       label = "tab:models")
#> Table saved to /tmp/Rtmp3J9jIQ/model_comparison.tex
