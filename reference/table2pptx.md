...
#> Table saved to /tmp/RtmpVRC0ab/example.pptx
...
table2pptx(results, file.path(tempdir(), "presentation.pptx"),
        ...
        dark_header = TRUE,
        bold_significant = TRUE)
#> Table saved to /tmp/RtmpVRC0ab/presentation.pptx
...
table2pptx(desc, file.path(tempdir(), "baseline.pptx"),
        ...
        font_size = 10)
#> Table saved to /tmp/RtmpVRC0ab/baseline.pptx
...
table2pptx(results, file.path(tempdir(), "conference.pptx"),
        ...
        dark_header = TRUE,
        condense_table = TRUE)
#> Table saved to /tmp/RtmpVRC0ab/conference.pptx
