...
#> Table saved to /tmp/Rtmp3J9jIQ/example.pptx
...
table2pptx(results, file.path(tempdir(), "presentation.pptx"),
        ...
        dark_header = TRUE,
        bold_significant = TRUE)
#> Table saved to /tmp/Rtmp3J9jIQ/presentation.pptx
...
table2pptx(desc, file.path(tempdir(), "baseline.pptx"),
        ...
        font_size = 10)
#> Table saved to /tmp/Rtmp3J9jIQ/baseline.pptx
...
table2pptx(results, file.path(tempdir(), "conference.pptx"),
        ...
        dark_header = TRUE,
        condense_table = TRUE)
#> Table saved to /tmp/Rtmp3J9jIQ/conference.pptx
