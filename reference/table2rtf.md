...
#> Table exported to /tmp/RtmpihKwyb/results.rtf
...
#> Table exported to /tmp/RtmpihKwyb/direct.rtf
ft <- flextable::bg(ft, bg = "yellow", part = "header")
...
table2rtf(desc, file.path(tempdir(), "baseline.rtf"),
       ...
       zebra_stripes = TRUE)
#> Table exported to /tmp/RtmpihKwyb/baseline.rtf
...
table2rtf(results, file.path(tempdir(), "efficacy.rtf"),
       ...
       orientation = "landscape",
       condense_table = TRUE)
#> Table exported to /tmp/RtmpihKwyb/efficacy.rtf
