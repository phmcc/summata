...
#> Table exported to /tmp/RtmpTulUTc/example.html
...
#> Table exported to /tmp/RtmpTulUTc/results.tex
...
#> Compiling PDF...
#> Table exported to /tmp/RtmpTulUTc/results.pdf
...
#> Compiling PDF...
#> Table exported to /tmp/RtmpTulUTc/demographics.pdf
...
#> Table exported to /tmp/RtmpTulUTc/model_comparison.docx
