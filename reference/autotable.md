...
#> Table exported to /tmp/RtmpihKwyb/example.html
...
#> Table exported to /tmp/RtmpihKwyb/results.tex
...
#> Compiling PDF...
#> Table exported to /tmp/RtmpihKwyb/results.pdf
...
#> Compiling PDF...
#> Table exported to /tmp/RtmpihKwyb/demographics.pdf
...
#> Table exported to /tmp/RtmpihKwyb/model_comparison.docx
