...
#> Table exported to /tmp/RtmpQw4LQZ/example.pptx
...
table2pptx(results, file.path(tempdir(), "presentation.pptx"),
        ...
        dark_header = TRUE,
        bold_significant = TRUE)
#> Table exported to /tmp/RtmpQw4LQZ/presentation.pptx
...
table2pptx(desc, file.path(tempdir(), "baseline.pptx"),
        ...
        font_size = 10)
#> Table exported to /tmp/RtmpQw4LQZ/baseline.pptx
...
table2pptx(results, file.path(tempdir(), "conference.pptx"),
        ...
        dark_header = TRUE,
        condense_table = TRUE)
#> Table exported to /tmp/RtmpQw4LQZ/conference.pptx
