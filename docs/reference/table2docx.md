...
#> Table exported to /tmp/Rtmpv9iBxt/results.docx
...
#> Table exported to /tmp/Rtmpv9iBxt/direct.docx
ft <- flextable::bg(ft, bg = "yellow", part = "header")
