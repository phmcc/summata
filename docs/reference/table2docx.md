...
#> Table exported to /tmp/RtmphwDdUy/results.docx
...
#> Table exported to /tmp/RtmphwDdUy/direct.docx
ft <- flextable::bg(ft, bg = "yellow", part = "header")
