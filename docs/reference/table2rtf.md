...
#> Table exported to /tmp/RtmpQw4LQZ/results.rtf
...
#> Table exported to /tmp/RtmpQw4LQZ/direct.rtf
ft <- flextable::bg(ft, bg = "yellow", part = "header")
...
table2rtf(desc, file.path(tempdir(), "baseline.rtf"),
       ...
       zebra_stripes = TRUE)
#> Table exported to /tmp/RtmpQw4LQZ/baseline.rtf
...
table2rtf(results, file.path(tempdir(), "efficacy.rtf"),
       ...
       orientation = "landscape",
       condense_table = TRUE)
#> Table exported to /tmp/RtmpQw4LQZ/efficacy.rtf
