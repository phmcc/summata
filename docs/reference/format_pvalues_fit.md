...
Converts numeric *p*-values to formatted character strings using
vectorized operations. Values below the threshold (determined by digits
parameter) display as "\< 0.001" (for digits=3), "\< 0.0001" (for
digits=4), *etc.* NA values display as "-".
