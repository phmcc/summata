...
The `compfit()` function uses several metrics for comparing models. For mathematical details, see the [Statistical Foundations](statistical_foundations.html) article.
...
The Composite Model Score (CMS) is a metric designed to facilitate rapid model comparison. It combines multiple quality indicators into a single value ranging from 0 to 100.
