...
Built on `data.table` for computational efficiency, `summata` demonstrates 35–54% faster execution than comparable workflows in other packages with a smaller dependency footprint. See the [Benchmarks](benchmarks.html) article for detailed comparisons.
