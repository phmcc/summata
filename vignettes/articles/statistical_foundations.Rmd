...
where *t*ₙ₋ₚ₋₁ is the *t*-quantile with *n* − *p* − 1 degrees of freedom. This produces wider intervals than the normal approximation, particularly when *n* is small relative to *p*.
