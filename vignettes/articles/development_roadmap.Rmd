...
Contributions to `summata` are welcome. If you are interested in implementing a roadmap feature or proposing a new one, please consult the contributing guidelines in the [package repository](https://codeberg.org/phmcc/summata).

## Bug Reports

Bug reports and feature requests may be submitted via the issue tracker, either on [Codeberg](https://codeberg.org/phmcc/summata/issues) or [GitHub](https://github.com/phmcc/summata/issues).
