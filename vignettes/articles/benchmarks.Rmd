...
knitr::include_graphics("figures/benchmarks_desctable.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "100%"}
knitr::include_graphics("figures/benchmarks_survtable.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "100%"}
knitr::include_graphics("figures/benchmarks_logistic.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "100%"}
knitr::include_graphics("figures/benchmarks_linear.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "100%"}
knitr::include_graphics("figures/benchmarks_poisson.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "100%"}
knitr::include_graphics("figures/benchmarks_cox.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "100%"}
knitr::include_graphics("figures/benchmarks_mixed.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "100%"}
knitr::include_graphics("figures/benchmarks_uniscreen.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "100%"}
knitr::include_graphics("figures/benchmarks_workflow.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "100%"}
knitr::include_graphics("figures/benchmarks_forest.png")
```
...
```{r, echo = FALSE, eval = TRUE, out.width = "100%"}
knitr::include_graphics("figures/benchmarks_speedup.png")
```
