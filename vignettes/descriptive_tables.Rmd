...
By default, Fisher exact test is used when any expected cell count falls below 5 for categorical variables. Similarly, the test selection for continuous variables will follow the displayed statistic unless otherwise specified: parametric tests are used with mean-based statistics, nonparametric tests with median-based statistics.
