...
```{r, echo = FALSE, out.width = "100%"}
show_plot(example10a, "forest_ex10a.png")
```
...
```{r, echo = FALSE, out.width = "100%"}
show_plot(example10b, "forest_ex10b.png")
```
...
```{r, echo = FALSE, out.width = "100%"}
show_plot(example11, "forest_ex11.png")
```
...
```{r, echo = FALSE, out.width = "100%"}
show_plot(example16a, "forest_ex16a.png")
```
...
```{r, echo = FALSE, out.width = "100%"}
show_plot(example16b, "forest_ex16b.png")
```
...
```{r, echo = FALSE, out.width = "100%"}
show_plot(example19, "forest_ex19.png")
```
...
```{r, echo = FALSE, out.width = "100%"}
show_plot(example20_modified, "forest_ex20.png")
```
...
```{r, echo = FALSE, out.width = "100%"}
show_plot(example21, "forest_ex21.png")
```
